...
class TestScanner(
    ...
    subscribers: List<LogEventSubscriber<TestBlockchainBlock, TestBlockchainLog, TestDescriptor>>,
...
) : BlockchainScanner<TestBlockchainBlock, TestBlockchainLog, TestBlock, TestLog, TestDescriptor>(
    blockchainClient,
    subscribers,
    blockMapper,
    blockService,
